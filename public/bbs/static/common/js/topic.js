...
var token=$("#token").val();
  $.ajax({                                                 //调用jquery的ajax方法   
    ...
    data: "comment="+comment+"&topic_id="+$("#topic_id").val()+"&is_top="+$("#is_top").val()+"&username="+$("#username").val()+"&avatar="+$("#avatar").val()+"&lastpost="+$("#lastpost").val()+"&layer="+$("#layer").val()+"&csrf_token="+token,    //输入框writer中的值作为提交的数据  
    dataType: 'json',  
