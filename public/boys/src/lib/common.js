...
function parse(resp, xhr) {
	...
	location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='+appid+'&redirect_uri=http://www.tupppai.com/wechat&response_type=code&scope=snsapi_userinfo&connect_redirect=1#wechat_redirect';
        //location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='+appid+'&redirect_uri=http://'+host+'/wechat'+rd+'&scope=snsapi_userinfo&connect_redirect=2#wechat_redirect';
        //图派男神活动授权
    }
