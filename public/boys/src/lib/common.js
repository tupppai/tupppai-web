...
function parse(resp, xhr) {
    ...
    if(resp.ret == 2) {
        ...
        var rd = encodeURIComponent('?hash='+location.hash.substr(1));
         location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='+appid+'&redirect_uri=http://'+host+'/wechat'+rd+'&scope=snsapi_userinfo&connect_redirect=1#wechat_redirect';
        //图派男神活动授权
    }
