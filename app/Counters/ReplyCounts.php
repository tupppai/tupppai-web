    ...
    public static function get($reply_id) {
        ...
        return self::query($key, function() use ( $key, $reply_id ) {
            $counts = [
				...
				'collect_count'
					=> sCount::countActionByTarget( mCount::TYPE_REPLY, $reply_id, mCount::ACTION_COLLECT ),
				'share_count'
				...
				'inform_count'
					=> sCount::countActionByTarget( mCount::TYPE_REPLY, $reply_id, mCount::ACTION_INFORM ),
				'click_count'
					=> sCount::countActionByTarget( mCount::TYPE_REPLY, $reply_id, mCount::ACTION_CLICK ),
				'comment_count'
					=> sCount::countActionByTarget( mCount::TYPE_REPLY, $reply_id, mCount::ACTION_COMMENT ),
				'reply_count'
					=> sCount::countActionByTarget( mCount::TYPE_REPLY, $reply_id, mCount::ACTION_REPLY ),
