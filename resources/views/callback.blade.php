...
<div class="container">
	<div class="row">
		<div class="col-md-offset-2 col-md-8">
			<form role="form" action="{{ url('oauth/access_token') }}" method="post">
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="redirect_uri" value="http://www.tupai.com/callback">
				</div>
				<div class="form-group">
					<label>code</label>
					<input class="form-control" type="text" name="code" value="{{ \Illuminate\Support\Facades\Input::get('code') }}" readonly="readonly">
				</div>
				<div class="form-group">
					<label>state</label>
					<input class="form-control" type="text" name="state" value="{{ \Illuminate\Support\Facades\Input::get('state') }}" readonly="readonly">
				</div>
				<div class="form-group">
					<label>scope</label>
