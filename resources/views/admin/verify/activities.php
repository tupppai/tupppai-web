 ...
 -->
        <div class="form-group">
            <select name="category_id" class="form-filter form-control">
                ...
                ?>
                    <option value="<?php echo $activity['id']; if( $catId == $activity['id']): echo '" selected="selected'; endif;?>"><?php echo $activity['display_name']; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="form-group">
...
<div class="tabbable-line">
    <ul class="nav nav-tabs">
      ...
      <li class="view_threads">
        <a href="/verify/activities?status=valid">全部</a>
      </li>
    </ul>
</div>
<div class="tabbable-line">
...
jQuery(document).ready(function() {
    ...
    table.init({
        src: $('#thread-data'),
        url: '/verify/list_category_threads?category_id='+category_id+'&category_type=activities&status='+status,
